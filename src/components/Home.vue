<template>
  <div class="welcome">
    <h2>Bienvenue sur <span class="logo">Pym</span> !</h2>
    <h3>Ici, tu peux consulter la liste de tous les plats, ingrédients et catégories existants, et en ajouter des nouveaux !</h3>
    <p>Comment créer un nouveau plat ?</p>
    <ul>
